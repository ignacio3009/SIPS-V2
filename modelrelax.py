...
def relaxLine(lin,relaxcapacity,verbose=False):
    ...
    for t in numHrs:
        for l in numLin:
            model.addConstr(f[l,0,t] <= FMAX[l]*B[l,0]) #scenario 0: must respect limits
            model.addConstr(f[l,0,t] >= -1*FMAX[l]*B[l,0]) #scenarios of contingencies can violate limits until a treshhold
...
if __name__ == '__main__':
    # relaxLine([1,2],[1.4,1.4])
# # relaxLine(1.5,1)
    relaxLine([1,2],[1.5,1.5])